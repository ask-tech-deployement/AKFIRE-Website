...
import { phone1, phone2, email, email2, whatsapp } from "../../utils";
  ...
  return (
    <>
      ...
      >
        ...
        <li>
          <a href={`mailto:${email2}`} className="text-dark">
            <MdEmail className="text-dark" /> {email2}
          </a>
        </li>
      ...
      <div
        ...
        style={{ backgroundColor: "#eda0313b", backdropFilter: "blur(11px)" }}
      >
        <button
          onClick={() => {
            handleMenuToggle();
