        ...
        <div className="container">
          ...
          <div className="row align-items-center mx-5 py-36 ">
            <div className="col-lg-6 my-4 mb-lg-0">
              <h5 className="font-weight-bold text-primary mb-3 flex-align-start">
                About{" "}
                <span className="text-dark"> AK Fire Safety Solutions Inc</span>
              </h5>
              <h2 className="mb-3">
          ...
          <div className="p-10">
            <p className="text-dark">
              AK Fire Safety Solutions Inc (MTI), established in 2017, is a
              leading supplier of high-quality office supplies, pantry
              consumables, housekeeping products, and equipment to the corporate
              world in Bangalore, Chennai, and Mumbai. With over 30 years of
              combined experience, our promoters have a deep understanding of
              the corporate supply industry, enabling us to offer reliable and
              consistent service. Our dedicated team, with over 40 years of
              collective experience, ensures timely and efficient deliveries
              tailored to your needs. Located in the heart of Bangalore's IT
              hubs, we serve key areas like ITPL and Electronic City, providing
              swift service and quick turnaround times. We also have a warehouse
              in SR Nagar, offering easy access to our range of products. At
              MTI, we are committed to making the lives of administrators and
              facilities managers easier with quality products and dependable
              service, all backed by our core values of integrity, reliability,
